const tw = {
  ...
  wallet_insufficient_balance: '錢包餘額不足',
  deGate_insufficient_fees: 'DeGate餘額不足以支付Gas Fee',
  token_search_placeholder: '搜索代幣，合約地址',
  token: '代幣',
  degate_balance: 'DeGate餘額',
  tips_gas: '用於執行此鏈上交易的Gas Fee 將從您的DeGate餘額中扣除。',
  tips_gas2: 'Gas Fee 涵蓋了交易結算的鏈上成本。多餘的費用將會退回。',
  Close: '關閉',
  Help: '幫助',
  no_token: '找不到代幣',
  Cancel: '取消',
  ...
  ledger_disconnect: '無法執行“transferOut”於“USBDevice”：裝置連接已中斷',
  ...
  export_key_warning: '資產金鑰的洩漏可能導致資產損失。請確保其安全',
  ...
  personal_sign_reason1: '1. MetaMask 已連接到硬體錢包',
  personal_sign_reason2: '2. MetaMask 版本過舊',
  ...
  period_expired: '已過期',
  period_D_day_H_hour: 'D天 H小時',
  period_H_hour_M_minute: 'H小時 M分鐘',
  login_success: '連接成功',
  advanced: '進階',
  edit: '編輯',
  save: '儲存',
  ...
  upcoming_lock_tips: '已閒置一段時間，為了確保安全，即將關閉免簽名模式',
  auto_locked_tips: '您已閒置15分鐘，為了確保安全，免簽名模式已關閉',
  keep: '保留',
  turn_off_now: '立即關閉',
  turn_on: '開啟',
  ...
  create_grid_strategy: '建立網格策略',
  create_DCA_plan: '建立定期定額計劃',
  cancel_order: '取消訂單',
  ...
  'ledger.address': '地址',
  'ledger.connect': '連接',
  'ledger.un_supported_title': '目前使用的瀏覽器不支援 Ledger 錢包連接',
  'ledger.un_supported_desc': '建議使用 Chrome 或 Edge 瀏覽器。',
  'ledger.confirm_gas_fee': '確認Gas Fee',
  'ledger.confirm_gas_fee_desc': '您即將在以太坊上發起交易，請確認：',
  'ledger.max_gas_fee': '最大 Gas Fee',
  ...
  'operations.claim_rewards_desc': '獎勵將在扣除Gas Fee後發送到您的帳戶',
  'operations.pay_deposit': '結算',
  'operations.pay_deposit_title': '待支付',
  'operations.pay_deposit_desc_XXX_ETH': '您有 XXX ETH待入帳。',
  ...
  'dca.creating_the_plan': '正在建立計劃...',
  'dca.maximum_price': '最高價格',
  'dca.minimum_price': '最低價格',
  'dca.do_not_close': '請勿關閉或重新載入此頁面。',
  'dca.frequency': '頻率',
  total_amount: '總金額',
  'dca.daily': '每天',
  'dca.weekly': '每週',
  ...
  grid_slippage_over_2_tips_SLIPPAGE_QUOTE_BASE:
    '初始時系統將使用市價訂單將 QUOTE 的一部分兌換為 BASE，預估滑價為 SLIPPAGE。',
  grid_slippage_over_5_tips_SLIPPAGE_QUOTE_BASE:
    '初始時系統將使用市價訂單將 QUOTE 的一部分兌換為 BASE，預估滑價為 SLIPPAGE。建議以雙資產模式進行投資。',
  connected: '已連接',
  browser_wallet: '瀏覽錢包',
  ...
  reset_approval_USDT: '重設 USDT 確認',
  reset_approval_USDT_tips: '當支出限額太低時，USDT 需要重設確認。',
  ...
  Economy_tips:
    'DeGate至少每4小時會處理一次發送操作，通常會更快。比如若其他使用者發起了快速發送，您的經濟發送請求也會一起被處理。',
  wrap: '跨鏈',
  just_a_moment: '請稍後',
